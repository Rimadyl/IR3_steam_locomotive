-- Steam locomotive entity
-- Credit @cupcakescankill
-- Modified: file names & paths, fuel_category changed to "steam-cell"
require("constants")

local custom_smoke = table.deepcopy(data.raw["trivial-smoke"]["train-smoke"])
custom_smoke.name = "meat:train-smoke"
...
local custom_properties = {
	...
	type = "locomotive",
	placeable_by = {
		item = "meat:steam-locomotive-item",
		count = 1
	},
	weight = 2000,
	...
	energy_source = {
		...
		render_no_power_icon = settings.startup["meat:steamtrain-disable"].value,
...
placement_entity.name = "meat:steam-locomotive-placement-entity"
